...
url = url = 'https://gw.jejudatahub.net/api/proxy/b9f1e4a56cd611eaa1d5aff3bc30f288/{b9f1e4a56cd611eaa1d5aff3bc30f288}?addressDong=구좌읍'

queryParams = '?' + urlencode({'number' : 1,
                      'pageNo' : 10,
                      'limit' : 'json',
                      'integer' : '',
                      'baseDate' : '',
